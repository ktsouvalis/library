...
class UserController extends Controller
{
    ...
    public function passwordChange(Request $request){
        ...
        $rules = [
            'pass1' => 'min:6|required_with:pass2|same:pass2',
            'pass2' => 'min:6'
        ];
    ...
    public function insertUsers(){
        ...
        return redirect(url('/user'))->with('success', "Η εισαγωγή $imported χρηστών ολοκληρώθηκε");
    }
    ...
    public function save_profile(User $user, Request $request){
        ...
        return redirect(url("/user_profile/$user->name"))->with('success','Επιτυχής αποθήκευση');
    }
